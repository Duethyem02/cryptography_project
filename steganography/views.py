...
def text_view(request):
    return render(request, 'steganography/text.html')


def image_view(request):
    return render(request, 'steganography/imgsteg.html')
...
def encryption_view(request):
    ...
    return render(request, 'steganography/encryption.html', {'message': message})
...
def decryption_view(request):
    ...
    return render(request, 'steganography/decryption.html', {'text': text})
